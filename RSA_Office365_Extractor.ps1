<#
RSA-IR O365 Extractor

	The idea for this script is based on a script developed by Tehnoon Raza (Microsoft) and published in the following blog:
...
Visit Github github.com/jrentenaar/Office-365-Extractor for the full readme
...
function Main{
	...
	"4" {
		...
		write-host "The different RecordTypes can be found on the Github page (https://github.com/jrentenaar/Office-365-Extractor)"
